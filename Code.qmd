...
protagonists in the top 100 box-office hits were women (Goodman, 2017) However,
merely having female protagonists does not paint the full picture if
...
continuous predictors (see Appendix for linearity plots for non-transformed variables). 
...
which a moviepremiered in is associated with differential odds of the moving
